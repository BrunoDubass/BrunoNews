//
//  BDBNotPublishedTableViewController.m
//  BrunoNews
//
...
#import "BDBNotPublishedTableViewController.h"
#import "BDBSharedKeys.h"
#import "BDBDetailNotPublishedViewController.h"
#import <WindowsAzureMobileServices/WindowsAzureMobileServices.h>

@interface BDBNotPublishedTableViewController (){
    MSClient *client;
    NSArray *news;
    NSString *userFBId;
    NSString *tokenFB;
...
@implementation BDBNotPublishedTableViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"detailNotPublished"]) {
        
        BDBDetailNotPublishedViewController *dNP = [[BDBDetailNotPublishedViewController alloc]initWithCoder:nil];
        
        dNP = segue.destinationViewController;
        dNP.detailNew = [news objectAtIndex:[self.tableView indexPathForSelectedRow].row];
    }
